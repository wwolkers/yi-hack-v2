...
#define __lc_monetary_data_LEN		152
#define __lc_monetary_rows_LEN		352
#define __lc_monetary_item_offsets_LEN		22
#define __lc_monetary_item_idx_LEN		88
#define __lc_messages_data_LEN		78
